(function () {
	...
	var rightSide = splitlayout.querySelector('div.intro > div.side-right');
	var pageRight = splitlayout.querySelector('div.page-right');
	...
	function init() {
		...
		var backToIntro = function (ev) {
			...
			var page = dir === 'right' ? pageRight : pageLeft;
		...
		checkHidden();
		plus.addEventListener(eventtype, function (e) {
